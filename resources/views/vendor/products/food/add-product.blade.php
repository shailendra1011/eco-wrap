                    ...
                    <form method="post" action="{{route('product.add')}}" enctype="multipart/form-data" id="myForm">
                        ...
                        <div class=" ml-4">
                            ...
                            <div class="form-group  row"><label
                                ...
                                <div class="col-sm-6"><input type="number" min="0" value="{{old('discount')}}"
                            ...
                            <div class="form-group  row"><label
                                ...
                                <div class="col-sm-6"><input type="number" value="{{old('delivery_charge')}}"
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label"><b>{{__('StaticWords.vendor.product_image')}}</b></label>
                                <div class="col-sm-3">
