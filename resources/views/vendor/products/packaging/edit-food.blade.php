                    ...
                    <form method="post" action="{{route('product.edit')}}" enctype="multipart/form-data" id="myForm">
                        ...
                        <div class=" ml-4">
                            <div class="form-group row"><label
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="{{$product->product_name?$product->product_name:old('product_name')}}" name="product_name"
                            ...
                            <div class="form-group  row"><label
                                ...
                                <div class="col-sm-6"><input type="number" min="0" value="{{$product->price?$product->price:old('price')}}" name="price"
                            ...
                            <div class="form-group  row"><label
                                ...
                                <div class="col-sm-6"><input type="number" value="{{$product->quantity?$product->quantity:old('quantity')}}" name="quantity"
                        ...
                        @if(\App\Language::where('country',auth()->user()->country)->first()->language_code == 'es')
                            <div class="form-group row"><label
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="{{$product->product_name_es?$product->product_name_es:old('product_name_es')}}" name="product_name_es"
                        ...
                        @else
                            <div class="form-group row"><label
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="{{$product->product_name_pt?$product->product_name_pt:old('product_name_pt')}}" name="product_name_pt"
