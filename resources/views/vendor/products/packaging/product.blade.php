    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h3>{{__('StaticWords.vendor.product_management_electronic')}} </h3>
            </div>
                    ...
                    <div class="col-md-10 float-left">
                        <div class="ibox float-e-margins no-border">
                            <div class="ibox-content" style="border: none;">
                                <h2 class="no-margins">{{__('StaticWords.vendor.total_product')}} : <span
                ...
                <div class="row ">
                    <div class="col-4 ">
                        <input type="text" id="search" onkeyup="get_data()"
                            placeholder="{{__('StaticWords.vendor.search_by_pro_name')}}" class="form-control">
                    </div>
                    <div class="col-4">
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>{{__('StaticWords.vendor.size')}}</th>
                                <th>{{__('StaticWords.vendor.quantity')}}</th>
                                {{-- <th>{{__('StaticWords.vendor.description_en')}}</th> --}}
                                <th>{{__('StaticWords.vendor.other_info')}}</th>
                ...
                if (res.data.data.length) {
                    ...
                    $.each(res.data.data, function (key, value) {
                        ...
                        <tr>
                            ...
                            <td>${"{{Session::get('locale')}}"=='en'?(value.other_info!=null?value.other_info:''):(value.other_info_es!=null?value.other_info_es:'')}</td> 
                        ...
                        row+=`      <li><a onclick="deleteProduct(${value.id})" class="btn btn-danger  dropdown-item" href="javascript:void(0)"><i class="fa fa-trash mr-3"></i>Delete</a></li>
                                </td>
                            </tr>
                        `;
