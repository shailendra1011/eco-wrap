    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top navbar-light bg-white shadow-sm " role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right mr-5">
                        ...
                        <li>
                            <img alt="image" style="cursor: pointer" data-toggle="dropdown" class="rounded-circle"
                                src="{{Auth::user()->image?url(Auth::user()->image):asset('admin/img/profile_small.jpg')}}" height="50"
                                width="50" />
                        ...
                        {{-- <li >
                            <div class="dropdown profile-element">
                                <img alt="image" class="rounded-circle" data-toggle="dropdown" class="dropdown-toggle" src="img/profile_small.jpg"/>
							...
							<ul class="dropdown-menu dropdown-alerts">
								<li>
									<a href="mailbox.html" class="dropdown-item">
										<div> <i class="fa fa-envelope fa-fw"></i> You have 16 messages <span class="float-right text-muted small">4 minutes ago</span>
										</div>
									</a>
								</li>
								<li class="dropdown-divider"></li>
								<li>
									<a href="profile.html" class="dropdown-item">
										<div> <i class="fa fa-twitter fa-fw"></i> 3 New Followers <span class="float-right text-muted small">12 minutes ago</span>
										</div>
									</a>
								</li>
								<li class="dropdown-divider"></li>
								<li>
									<a href="grid_options.html" class="dropdown-item">
										<div> <i class="fa fa-upload fa-fw"></i> Server Rebooted <span class="float-right text-muted small">4 minutes ago</span>
										</div>
									</a>
								</li>
								<li class="dropdown-divider"></li>
								<li>
									<div class="text-center link-block">
										<a href="notifications.html" class="dropdown-item"> <strong>See All Alerts</strong>
            ...
            <div class="footer">
                <div class="float-right">
                    <div> <strong>Copyright</strong> {{ config('app.name', 'Laravel') }} &copy; 2021-2022</div>
                </div>
            </div>
        </div>
    </div>
