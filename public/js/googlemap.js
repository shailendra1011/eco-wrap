...
$.getScript('https://maps.googleapis.com/maps/api/js?key=AIzaSyCevmzXDcdgwj2hVFoaMBCWBAbYy2MjE68&libraries=places',
function () {
...
params.success(convertAddress(), place, showId);
$modal.modal("hide")
});
...
var autocomplete = new google.maps.places.Autocomplete(document.getElementsByClassName(
"autocomplete")[0]);
...
if (results[0]) {
result = results[0];
var cont = "<h6 style='font-weight:600;font-size: 16px;padding-bottom: 10px;'>" + result
.formatted_address + "</h6>";
